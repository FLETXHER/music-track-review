...
| Dimension | Approx. weight | Higher appeal | Lower appeal |
|---|---:|---|---|
| Melody / hook | 25% | memorable, singable, clear hook or refrain | unusual intervals, weak or absent hook, difficult-to-follow melodic writing |
| Rhythm / groove | 25% | predictable pulse, stable groove, easy bodily entrainment | highly fragmented rhythm, frequent meter disruption, hard-to-locate pulse |
| Arrangement accessibility | 20% | clear texture, familiar harmonic movement, readable sections | dense/empty texture, frequent modulation, unusually complex harmonic language |
| Timbre / mix accessibility | 20% | rounded/familiar timbres, clear vocal focus, comfortable balance | abrasive/noisy/industrial timbres, extreme vocal processing, deliberately difficult sonics |
| Structural familiarity | 10% | recognizable sections and expected returns | linear/non-repeating form, extreme length, interlude-like or fragmentary structure |
...
- **3/5** — broadly understandable but has obvious limits: weak traditional hook, long/slow form, niche vocal delivery, unusual production, or reduced pop structure.
...
4. **Vocal / performance**
   ...
   - emotional fit and interaction with the arrangement;
